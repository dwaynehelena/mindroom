...
async def _record_model_call(
    *,
    ...
    # Deferred: flight_recorder pulls in aiosqlite, which slim entry points must not import at module load.
    from mindroom.flight_recorder import record_flight_event  # noqa: PLC0415
